// Centralized data source for the whole site
  ...
  roles: [
    ...
    },
    {
      ...
      highlights: [
        ...
        "Deployed SOAR with 25+ integrations, 6 runbooks, automated ticketing, and productivity gains via O365 and Slack.",
        "Built converged monitoring patterns (cyber + physical signals) to inform incident response and advise business partners.",
        "Evaluated low-friction access/orchestration approaches to improve user experience without compromising security.",
      ],
    },
    {
      company: "Oportun",
      ...
      highlights: [
        "Owned system maintenance for 350+ global locations and built incident response roadmaps for cyber intelligence maturation.",
        "Assessed cyber tool stack and remediation capacity; implemented SIEM for logging/monitoring and compliance.",
        "Launched phishing program and metrics; supported incident response and investigations.",
        "Supervised global access control federation across 10 locations and ~3K employees; established global physical security baselines and lifecycle.",
        "Advanced convergence of cyber and physical security practices—aligned credential management and policy across teams to reduce risk and friction.",
        "Co-led return-to-work planning with Legal, HR, Safety, BCP, and Facilities; balanced privacy, health information handling, and operational resilience.",
      ],
    },
    {
      ...
      highlights: [
        "Coordinated security risk assessments and penetration testing to NERC-CIP standards; enforced vendor compliance.",
        "Administered emergency basecamp operations during 2017 & 2018 wildfires.",
        "Tracked onboarding & training for 670+ contracted security officers; managed vendor contracts across 8 sites (≈3.1K hours/week).",
      ],
    },
  ] as Role[],
